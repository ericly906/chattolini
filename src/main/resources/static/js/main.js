...
function onMessageReceived(payload) {
    ...
    if(message.type === 'JOIN') {
        ...
        usernameText.innerHTML = "<button style='background: none;border: none;padding: 0;text-decoration: underline;cursor: pointer;font-size: 18px;color: #1f1f1f;'>" + message.sender + '\xa0\xa0\xa0\xa0\xa0\xa0\xa0' + currentTime + "</button>";
